...
type UpstreamEndpoints struct {
	...
	// ClaudeAuthURL is the OAuth authorization URL for Claude.
	// Default: https://claude.ai/oauth/authorize
	ClaudeAuthURL string `yaml:"claude-auth-url" json:"claude-auth-url"`

	// ClaudeTokenURL is the OAuth token endpoint URL for Claude.
	// Default: https://api.anthropic.com/v1/oauth/token
	ClaudeTokenURL string `yaml:"claude-token-url" json:"claude-token-url"`

	// CodexAuthURL is the OAuth authorization URL for Codex.
	// Default: https://auth.openai.com/oauth/authorize
	CodexAuthURL string `yaml:"codex-auth-url" json:"codex-auth-url"`

	// CodexTokenURL is the OAuth token endpoint URL for Codex.
	// Default: https://auth.openai.com/oauth/token
	CodexTokenURL string `yaml:"codex-token-url" json:"codex-token-url"`

	// KiroAuthEndpoint is the OAuth endpoint for Kiro authentication.
	// Default: https://prod.us-east-1.auth.desktop.kiro.dev
	KiroAuthEndpoint string `yaml:"kiro-auth-endpoint" json:"kiro-auth-endpoint"`

	// KiroAPIEndpoint is the API endpoint for Kiro CodeWhisperer services.
	// Default: https://codewhisperer.us-east-1.amazonaws.com
	KiroAPIEndpoint string `yaml:"kiro-api-endpoint" json:"kiro-api-endpoint"`

	// VertexBaseURL is the base URL for Vertex AI API.
	// Default: https://generativelanguage.googleapis.com
	VertexBaseURL string `yaml:"vertex-base-url" json:"vertex-base-url"`

	// AIStudioBaseURL is the base URL for Google AI Studio API.
	// Default: https://generativelanguage.googleapis.com
	AIStudioBaseURL string `yaml:"aistudio-base-url" json:"aistudio-base-url"`
}
