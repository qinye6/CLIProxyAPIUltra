...
import (
	...
	"github.com/qinye6/CLIProxyAPIUltra/internal/auth/copilot"
	geminiAuth "github.com/qinye6/CLIProxyAPIUltra/internal/auth/gemini"
	iflowauth "github.com/qinye6/CLIProxyAPIUltra/internal/auth/iflow"
	"github.com/qinye6/CLIProxyAPIUltra/internal/auth/kilo"
	"github.com/qinye6/CLIProxyAPIUltra/internal/auth/kimi"
	kiroauth "github.com/qinye6/CLIProxyAPIUltra/internal/auth/kiro"
	"github.com/qinye6/CLIProxyAPIUltra/internal/auth/qwen"
	"github.com/qinye6/CLIProxyAPIUltra/internal/interfaces"
	"github.com/qinye6/CLIProxyAPIUltra/internal/misc"
...
// setTokenInvalidState marks the auth token as invalid or valid.
...
// isInvalidAuthFileCandidate checks if the auth is a candidate for invalid file cleanup.
...
// deleteInvalidAuthFilesInternal removes invalid auth files and returns deleted and matched counts.
...
// isSupportedTokenVerifyProvider checks if the provider supports token verification.
...
// normalizeTokenInvalidReason normalizes the invalid reason string.
...
// verifyAuthTokenState verifies the auth token state and updates metadata.
...
// verifyInvalidEntry represents a single verification result.
...
// verifyInvalidBatchResult represents the result of a batch verification.
...
// filterVerifyInvalidCandidates filters auth entries for verification.
...
// verifyInvalidAuthBatch verifies a batch of auth tokens and returns the result.
...
// verifyCodexAuthToken verifies a Codex auth token by probing the usage endpoint.
...
// probeCodexUsage probes the Codex usage endpoint to verify token validity.
...
// codexAccountID extracts the account ID from auth metadata.
